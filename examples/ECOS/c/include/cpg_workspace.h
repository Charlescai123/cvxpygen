...
// Canonical parameters
extern cpg_float canon_c[3];
extern cpg_float canon_c_conditioning[3];
extern cpg_csc canon_G;
extern cpg_csc canon_G_conditioning;
extern cpg_float canon_h[7];
extern cpg_float canon_h_conditioning[7];
