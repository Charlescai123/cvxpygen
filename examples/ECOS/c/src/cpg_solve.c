...
void cpg_solve(){
  ...
  if (!ecos_workspace ) {
    cpg_copy_all();
    ecos_workspace = ECOS_setup(3, 7, 0, 2, 1, (int *) &ecos_q, 0, Canon_Params_conditioning.G->x, Canon_Params_conditioning.G->p, Canon_Params_conditioning.G->i, 0, 0, 0, Canon_Params_conditioning.c, Canon_Params_conditioning.h, 0);
  } else {
